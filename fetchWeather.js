import fs from 'fs' //library called file system for from and to files
import path from 'path' //helps us build a file paths that work into out environment
import dotenv from 'dotenv' //package that allows us to read from dotenv
...
export async function fetchWeather() {
    ...
    try {
        ...
        data._last_updated_utc = nowUTC // new property 
        fs.writeFileSync(WEATHER_FILE, JSON.stringify(data, null, 2)) //writing data obj to weather file
    ...
    console.log(`Weather data updated for the ${city} at ${nowUTC}`);
}
catch(err) {
